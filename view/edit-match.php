    ...
    <div class="columns" style="margin-top:20px;">
        ...
        <div class="column">
            <div class="columns is-centered">
                ...
                <p class="title">Urejanje " <?= $match["NAZIV"] ?> "</p>
            ...
            <?php endif; ?>
                <form action="<?= BASE_URL . "edit-match"?>" method="post">
                <div class="field" style="margin-top: 20px">
                    <label class="label">Naziv tekme</label>
                    <div class="control has-icons-left has-icons-right">
                    <input name = "NAZIV" id="match_title" value="<?= $match["NAZIV"]?>" class="input" type="text" placeholder="npr. Petkova liga" required>
                    <span class="icon is-small is-left">
                    <i class="fas fa-heading"></i>
                </span>
                <div class="field" style="margin-top: 20px">
                    <label class="label">ID tekme</label>
                    <div class="control has-icons-left has-icons-right">
                    <input name = "MID" id="match_title" value="<?= $match["MID"]?>" class="input" type="text" placeholder="npr. Petkova liga" disabled>
                    <span class="icon is-small is-left">
                ...
                <div class="field" style="margin-top: 20px">
                    ...
                    <div class="field" style="margin-top: 20px">
                        <label class="label">Datum tekmovanja</label>
                            <div class="control has-icons-left has-icons-right">
                                <input name="DATUM" id="match_date" class="input" min="6/3/2020" type="date" value="<?= $match["DATUM"]?>" required>
                        <span class="icon is-small is-left">
            ...
            <div class="field" style="margin-top: 20px">
                ...
                <textarea name="OPISTEKME" id="description" class="textarea is-info" placeholder="Povej ostalim igralcem na kaj se prijavljajo" rows="5"><?= $match["OPISTEKME"]?></textarea>
            </div>
            <div class="field" style="margin-top: 20px">
            ...
            <div class="control">
                <button type="submit" class="button is-link">Posodobi</button>
            </div>
            </form>
            <div class="control">
